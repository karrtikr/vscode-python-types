...
/**
 * Type Definition for Visual Studio Code Python Extension's API. This is the public API for other extensions to interact with this extension.
 */

declare module 'vscode-python' {
